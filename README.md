# La Chouette Agence
Quatrième projet de mon parcours développeur web chez OpenClassrooms.
L'objectif est d'optimiser un site web existant.

![maquette web reservia](./img/La_Chouette_Agence.png)
...
## Site web non optimisé
 Le site web non optimisé est consultable par [ici](https://lucbourrat.github.io/DW-P4-website/)
